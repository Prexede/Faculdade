...
int main(void)
{
  ...
  uint8_t STRING[]  = "Pratica de Controle Digital!\r\n";
  HAL_GPIO_WritePin(GPIOC, R_LED_Pin, GPIO_PIN_RESET);
  HAL_GPIO_WritePin(GPIOC, Y_LED_Pin, GPIO_PIN_RESET);
  //float atraso = 0.0;
  ...
  {
    /* USER CODE END WHILE */
	  HAL_GPIO_WritePin(GPIOC, R_LED_Pin, GPIO_PIN_SET);
	  HAL_UART_Transmit(&huart1, STRING,sizeof(STRING),1000);
	  HAL_GPIO_WritePin(GPIOC, R_LED_Pin, GPIO_PIN_RESET);
	  HAL_GPIO_WritePin(GPIOC, Y_LED_Pin, GPIO_PIN_SET);
	  HAL_Delay(5);
	  HAL_GPIO_WritePin(GPIOC, Y_LED_Pin, GPIO_PIN_RESET);
...
static void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOC, LED1_Pin|R_LED_Pin|Y_LED_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : R_LED_Pin Y_LED_Pin */
  GPIO_InitStruct.Pin = R_LED_Pin|Y_LED_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_OUTPUT_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
